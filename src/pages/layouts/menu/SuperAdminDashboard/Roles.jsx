...
const rolePermissions = { superAdmin: ['View & Edit All Modules', 'Approve/Reject Doctors', 'Approve/Reject Hospitals', 'Approve/Reject Pharmacies', 'Approve/Reject Labs', 'Manage All Patients', 'Manage All Transactions', 'Access Settings', 'Access Billing & Reports', 'Manage Sub Admins'], subAdmin: ['View & Edit All Modules', 'Approve/Reject Doctors', 'Approve/Reject Hospitals', 'Approve/Reject Pharmacies', 'Approve/Reject Labs', 'Manage All Patients', 'Access Billing Info', 'View Transactions', 'Limited Access to Settings', 'Generate Reports'], patient: ['Book Appointments', 'Download Health Card', 'View/Upload Reports', 'View Transactions', 'Add Presptions', 'Tracking Delievry'], hospital: ['Add/Edit Assosiated Doctors', 'Add/Edit Staffs', 'Add/Edit Departments', 'Manage Patients', 'Add Patients in OPD', 'Assign Departments to Doctors', 'Billing & Payments', 'View & Manage All Appointments', 'View Reports', 'View Prescrptions'], freelancerDoctor: ['Access Patient History', 'Prescribe Medications', 'Request Lab Tests', 'View Appointments', 'Refer Labs', 'Access Payments'], PocketClinicDoctor: ['Access Patient History', 'Prescribe Medications', 'View Appointments', 'Prescribe Medication'], pharmacy: ['View Prescriptions', 'Add Medications', 'Manage Inventory', 'Track Orders', 'Handle Delivery', 'Generate Reports'], lab: ['Add Test/Scans', 'Upload Reports', 'View Prescriptions', 'Manage Inventory', 'Manage Appointments', 'Generate Bills', 'Track Test Deliveries', 'View Appointments'] };
const roleLabels = { superAdmin: 'Super Admin', subAdmin: 'Sub Admin', patient: 'Patient', hospital: 'Hospital', freelancerDoctor: 'Freelancer Doctor', PocketClinicDoctor: 'AV Swasthya Doctor', pharmacy: 'Pharmacy', lab: 'Lab / Scan Center' };
const roleTags = { superAdmin: 'bg-[#0E1630] text-white', subAdmin: 'bg-[#01D48C] text-white', patient: 'bg-blue-100 text-blue-700', hospital: 'bg-purple-100 text-purple-700', freelancerDoctor: 'bg-orange-100 text-orange-700', PocketClinicDoctor: 'bg-pink-100 text-pink-700', pharmacy: 'bg-green-100 text-green-700', lab: 'bg-yellow-100 text-yellow-700' };
