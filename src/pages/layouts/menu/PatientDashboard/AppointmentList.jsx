...
// useEffect(() => {
//   console.log("🔥 useEffect fired. data =", data, "patientId =", patientId);

//   // If data already loaded OR no patientId => stop API call
//   if (data || !patientId) {
//     console.log("⛔ Stopping fetch: data exists or no patientId.");
//     return;
//   }
...
//       console.log("🧪 Lab Appointments:", labAppointments);
