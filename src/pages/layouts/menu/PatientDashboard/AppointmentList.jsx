...
//   const selectedRecord = clickedRecord || {
...
//   };
//   useEffect(() => {
//   console.log("clickedRecord changed:", clickedRecord);
// }, [clickedRecord]);
...
// // ... (keep all your existing helper components and functions as-is)
...
//   const { clickedRecord, activeTab } = useMedicalRecords();
//   const printContentRef = useRef();
//   const [selectedRecord, setSelectedRecord] = useState(clickedRecord || {
//     patientName: "John Doe", age: "45", sex: "Male", id: "P001", hospitalName: "General Hospital", diagnosis: "Chest Pain", dateOfVisit: "2024-01-15", "K/C/O": "Hypertension", vitals: { bp: "140/90", pulse: "80", temp: "98.6" }, medicalDetails: {
//       chiefComplaint: "Chest pain since 2 days", pastHistory: "Hypertension for 5 years", examination: "Tenderness over chest",
//     }, prescriptionsData: [{ date: "2024-01-15", doctorName: "Dr. Smith", medicines: "Aspirin 75mg", instructions: "Once daily", }], labTestsData: [{ date: "2024-01-15", testName: "ECG", result: "Normal", normalRange: "Normal", status: "Normal", }],
//   });

//   // Add these functions for fetching data
//   const getClinicalData = async (patientId) => {
//     try {
//       const response = await axios.get(`/api/clinical/${patientId}`);
...
//   useEffect(() => {
//     const fetchData = async () => {
//       if (!clickedRecord?.id) return;
//       try {
//         const clinicalData = await getClinicalData(clickedRecord.id);
//         const prescriptions = await getPrescriptions(clickedRecord.id);
//         setSelectedRecord(prev => ({
//           ...prev,
//           medicalDetails: clinicalData,
...
//   // ... (keep all your existing state and handlers as-is)
